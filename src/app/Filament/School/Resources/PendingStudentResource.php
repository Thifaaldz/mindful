...
use App\Filament\School\Resources\PendingStudentResource\Pages;
use App\Models\User;
...
class PendingStudentResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Murid Pending';
    protected static ?string $pluralModelLabel = 'Murid Pending';
