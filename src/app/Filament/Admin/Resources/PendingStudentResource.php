...
use App\Filament\Admin\Resources\PendingStudentResource\Pages;
...
class PendingStudentResource extends StudentResource
{
    use HandlesSchoolUserApproval;

    protected static ?string $navigationGroup = 'Murid';
    protected static ?string $navigationLabel = 'Pendaftaran Murid';
    protected static ?string $modelLabel = 'Pendaftaran Murid';
    protected static ?string $pluralModelLabel = 'Pendaftaran Murid';
    ...
    {
        $count = User::role('student')->where('approval_status', 'pending')->count();
    ...
    {
        return [
            'index' => Pages\ListPendingStudents::route('/'),
            'edit' => Pages\EditPendingStudent::route('/{record}/edit'),
        ];
    }
}
